...
<body>
	...
	<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10" style="padding: 0">
		...
		<!--表单-->
		<s:form action="addApart" method="post">
			<div class="row" style="margin-bottom:20px">
				<div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
					<s:fielderror fieldName="apartname"/>
					<div class="input-group">
						<span class="input-group-addon"> 部门名称：</span> 
						<s:textfield class="form-control" name="apartname" />
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
					...
					<div class="input-group">
						...
						<s:textfield class="form-control" name="remark"/>
					</div>
				</div>
			</div>
