...
<body>
	...
	<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10" style="padding: 0">
		...
		<!--表单-->
		<form action="${pageContext.servletContext.contextPath }/addJob" method="post">
			<div class="row" style="margin-bottom:20px">
				<div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
					<div class="input-group">
						<span class="input-group-addon"> 职位名称：</span> <input type="text"
							class="form-control" name="jobname">
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
					<div class="input-group">
